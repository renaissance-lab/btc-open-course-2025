...
def main():
    ...
    txid = "05d1da11f11b55239f9397fa81d6bd18e16067cf4335190ec6af7678827dbfff"
    vout = 1
    amount = to_satoshis(0.00001111)  # 来自 commit 阶段

    # 构造输出地址（Bob 收款地址）
    to_addr = bob_pub.get_taproot_address()
    txin = TxInput(txid, vout)
    txout = TxOutput(to_satoshis(0.00000900), to_addr.to_script_pub_key())
