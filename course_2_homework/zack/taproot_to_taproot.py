...
def main():
    ...
    # 发送方信息（使用正确的私钥）
    from_private_key = PrivateKey('cNUUxnhdmwhbzryAEstuf1yieo8EDiGTkCeAEHB15vbB9rdtnUxL')
    ...
    print(f"Generated address: {from_private_key.get_public_key().get_taproot_address().to_string()}")
    ...
    # 创建交易输入
    txin = TxInput(
        '575d7ee651504ab1d12f7811a38746e5a5159b4b4efb4229bbce289dc6506caf',
        0
    )
    
    # 输入金额（用于签名）
    input_amount = 0.00009
    ...
    # https://mempool.space/testnet/tx/575d7ee651504ab1d12f7811a38746e5a5159b4b4efb4229bbce289dc6506caf
