...
def main():
    ...
    # 发送方信息
    from_private_key = PrivateKey('cQypWJeasiAFVubwDVqW9KmPJ2mMPKVmtjrrqb4t39Zgt5qF3Eos')
    ...
    p2pkh_addr = from_pub.get_address()
    script_code = p2pkh_addr.to_script_pub_key()  # SegWit 签名时应使用 P2PKH 的 scriptPubKey
    ...
    print(f"Expected address: tb1qjk6zkdm2eypnq7zdnuchkxannl7shgz3nzs9n6")

    # 接收方信息（ Legacy 地址）
    to_address = P2pkhAddress('mhF9KV42o1Nw77gfScVCKLJSeSejqMLTCd')
    ...
    # 创建交易输入
    txin = TxInput(
        'fd533d70436ead97753b7eb81334a1a4783471929bbde7993aa5b9cf05313a3f',  # 前一个交易的ID
        0  # vout
    )

    # 计算金额（单位：BTC）
    total_input = 0.00001  # 输入金额
    amount_to_send = 0.000008   # 发送金额
