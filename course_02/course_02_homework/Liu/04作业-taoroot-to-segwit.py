...
def main():
    ...
    # 接收方地址
    to_address = P2wpkhAddress('tb1qs8r637dl3nvt7qsrfnnl0utau3phaps4gdq84x')

    # 创建交易输入
    txin = TxInput(
        'abef5776c0acfb2dab24addebf07be00e9b165d3926fcb4aece183eaf5c49af0',
        0
    )
