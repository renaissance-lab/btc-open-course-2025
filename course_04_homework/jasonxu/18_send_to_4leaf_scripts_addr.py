...
#
# Send from a P2PKH UTXO and send to P2TR addr, 
...
p2tr_address = P2trAddress(conf.get("testnet3", "tr_4leaf_scripts_addr"))
print("To address:", p2tr_address.to_string())
...
txout = TxOutput(9760, p2tr_address.to_script_pub_key())
txout_change = TxOutput(270000, from_addr.to_script_pub_key())
